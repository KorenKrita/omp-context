...
describe("manual tree navigation summaries", () => {
    it("leaves native OMP tree summarization untouched because session_before_tree cannot override its prompt", () => {
        const handlers = captureHandlers();
        expect(handlers.get("session_before_tree")).toBeUndefined();
    });
});
