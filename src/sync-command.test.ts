...
test("declares the complete canonical guidance surface for the integrated plugin", () => {
  ...
  expect(manifest.mappings.map((mapping) => `${mapping.source}=>${mapping.destination}:${mapping.transform}`).sort()).toEqual([
    ...
    "src/live-agent-session-adapter.ts=>packages/omp-plugin/src/acm/live-agent-session-adapter.ts:copy",
    ...
    "src/runtime.test.ts=>packages/omp-plugin/src/acm/runtime.test.ts:copy",
    ...
    "test/host-fixture/agent-session-adapter.test.ts=>packages/omp-plugin/src/acm/host-fixture/agent-session-adapter.test.ts:copy",
    ...
    "test/host-fixture/travel-live-sync.test.ts=>packages/omp-plugin/src/acm/host-fixture/travel-live-sync.test.ts:copy",
